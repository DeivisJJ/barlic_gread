...
test.describe('Build 1 test suite', () => {
 ...
 test.beforeEach(async () => {
    ...
    test('Test if build 1 calculator works with add positive', async () => {
    ...
    test('Test if build 1 calculator works with add negative', async () => {
      await startPage.fill('#number1Field', '-2.5');
      await startPage.fill('#number2Field', '-2');
      await startPage.selectOption('#selectOperationDropdown', '0');
      await startPage.click('#calculateButton');
    ...
    test('Test if build 1 calculator works with add negative and integer numbers only', async () => {
      await startPage.fill('#number1Field', '-2.5');
      await startPage.fill('#number2Field', '-2');
      await startPage.selectOption('#selectOperationDropdown', '0');
      await startPage.click('#integerSelect');
    ...
    test('Test if build 1 calculator works with subtract negative', async () => {
      await startPage.fill('#number1Field', '-2');
      await startPage.fill('#number2Field','-1.5');
      await startPage.selectOption('#selectOperationDropdown', '1');
      await startPage.click('#calculateButton');
    ...
    test('Test if build 1 calculator works with subtract and integer numbers only', async () => {
      await startPage.fill('#number1Field', '2');
      await startPage.fill('#number2Field','1.5');
      await startPage.selectOption('#selectOperationDropdown', '1');
      await startPage.click('#integerSelect');
    ...
    test('Test if build 1 calculator works with subtract negative and integer numbers only', async () => {
      await startPage.fill('#number1Field', '-2');
      await startPage.fill('#number2Field','-1.5');
      await startPage.selectOption('#selectOperationDropdown', '1');
      await startPage.click('#integerSelect');
    ...
    test('Test if build 1 calculator works with multiply negative', async () => {
      await startPage.fill('#number1Field', '-1.5');
      await startPage.fill('#number2Field', '-1.5');
      await startPage.selectOption('#selectOperationDropdown', '2');
      await startPage.click('#calculateButton');
    ...
    test('Test if build 1 calculator works with multiply negative and integer numbers only', async () => {
      await startPage.fill('#number1Field', '-1.5');
      await startPage.fill('#number2Field', '-1.5');
      await startPage.selectOption('#selectOperationDropdown', '2');
      await startPage.click('#integerSelect');
    ...
    test('Test if build 1 calculator works with divide negative', async () => {
      await startPage.fill('#number1Field', '-5');
      await startPage.fill('#number2Field', '-2');
      await startPage.selectOption('#selectOperationDropdown', '3');
      await startPage.click('#calculateButton');
    ...
    test('Test if build 1 calculator works with divide negative and integer numbers only', async () => {
      await startPage.fill('#number1Field', '-5');
      await startPage.fill('#number2Field', '-2');
      await startPage.selectOption('#selectOperationDropdown', '3');
      await startPage.click('#integerSelect');
    ...
    test('Test if build 1 calculator works with add and symbol', async () => {
    ...
    test('Test if build 1 calculator works with subtract and symbol', async () => {
      await startPage.fill('#number1Field', '2a');
      await startPage.fill('#number2Field', 'b');
      await startPage.selectOption('#selectOperationDropdown', '1');
      await startPage.click('#calculateButton');
    ...
    test('Test if build 1 calculator works with multiply and symbol', async () => {
      await startPage.fill('#number1Field', '2a');
      await startPage.fill('#number2Field', 'b');
      await startPage.selectOption('#selectOperationDropdown', '2');
      await startPage.click('#calculateButton');
    ...
    test('Test if build 1 calculator works with divide and symbol', async () => {
      await startPage.fill('#number1Field', '2a');
      await startPage.fill('#number2Field', 'b');
      await startPage.selectOption('#selectOperationDropdown', '3');
      await startPage.click('#calculateButton');
    ...
    test('Test if build 1 calculator works with concatenate and symbol', async () => {
      await startPage.fill('#number1Field', '2a');
      await startPage.fill('#number2Field', 'b');
      await startPage.selectOption('#selectOperationDropdown', '4');
      await startPage.click('#calculateButton');
      const answerContent = await startPage.getInputValue('#numberAnswerField');
      expect(answerContent).toBe('2ab');
    });

    test('Test if build 1 calculator clear button works', async () => {
      await startPage.fill('#number1Field', '2.5');
      await startPage.fill('#number2Field', '2');
      await startPage.selectOption('#selectOperationDropdown', '0');
      await startPage.click('#calculateButton');
